...
3. l’utilizzatore finale viene indirizzato sul WISP (:ref:`vedi § 2.1.3 <http://pagopa-specifichepagamenti.readthedocs.io/it/latest/_docs/Capitolo2.html#scelta-del-servizio-di-pagamento-da-parte-dell-utilizzatore-finale>`_) 
...
sul sito dell'Agenzia (`vedi Appendice 2 delle SANP <http://pagopa-specifichepagamenti.readthedocs.io/it/latest/_docs/APPENDICE2%E2%80%93TRANSAZIONI_MYBANK_ATTRAVERSO_IL_NODO_DEI_PAGAMENTI_-_SPC.html#>`_).
...
.. _automazione-dellavviso-analogico:
...
.. _riconciliazione-in-modalita-singola:
...
.. _riconciliazione-in-modalita-multipla:
...
.. _pagamento-contenente-piu-accrediti:
...
6. l’utilizzatore finale autorizza il pagamento (vedi passi 4 e 5 del
   workflow di cui al :ref:`§ 2.1.1 <processo-di-pagamento-con-re-indirizzamento-on-line>`);
...
.. _invio-degli-avvisi-in-modalita-file-transfer:
...
.. _invio-degli-avvisi-in-modalita-web-service:
...
.. _comunicazione-dellesito-del-recapito-allente-creditore:
